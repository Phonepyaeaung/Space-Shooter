...
def main():
    ...
    player_vel = 5
    laser_vel = 4
    main_font = pygame.font.SysFont("Plavsky", 50)
    lost_font = pygame.font.SysFont("Orbitron-Black", 70)
    ...
    def redraw_window():
        WIN.blit(BG, (0, 0))
        # draw text
        lives_label = main_font.render(f"Live: {lives}", 1, (255, 0, 0))
...
def main_menu():
    title_font = pygame.font.SysFont("Orbitron-Black", 35)
    run = True
    while run:
        WIN.blit(BG, (0, 0))
